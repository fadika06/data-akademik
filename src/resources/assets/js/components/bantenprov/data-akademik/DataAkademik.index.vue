...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/data-akademik/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/data-akademik/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/data-akademik/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/data-akademik/' + rowData.id)
